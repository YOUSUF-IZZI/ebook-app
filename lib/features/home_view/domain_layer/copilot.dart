...
class VolumeInfo {
  ...
  factory VolumeInfo.fromJson(Map<String, dynamic> json) {
    return VolumeInfo(
      ...
      industryIdentifiers: List<IndustryIdentifiers>.from(json['industryIdentifiers'].map((x) => IndustryIdentifiers.fromJson(x))),
...
class SaleInfo {
  ...
  factory SaleInfo.fromJson(Map<String, dynamic> json) {
    return SaleInfo(
      ...
      offers: List<Offers>.from(json['offers'].map((x) => Offers.fromJson(x))),
    );
  }
}
